...
const fields = [
  ...
  { label: 'Your Email',   name: 'userEmail',   type: 'email',  placeholder: 'Enter your email' },
...
function CreateBookings() {
  const [form, setForm]     = useState({ userId:'', resourceId:'', userEmail:'', bookingDate:'', startTime:'', endTime:'', purpose:'', attendees:'' })
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setAlert({ type: 'success', title: 'Booking Submitted', message: 'Your request is now pending admin approval. Check your email for confirmation.' })
      setForm({ userId:'', resourceId:'', userEmail:'', bookingDate:'', startTime:'', endTime:'', purpose:'', attendees:'' })
    } catch (err) {
