...
const ChatBot = () => {
  ...
  const handleKeyPress = (e) => { if (e.key === "Enter") sendMessage(message); };
  ...
  return (
    <div className="admin-bg min-h-screen py-10 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        {/* Header */}
        <div className="mb-6">
          <Link to="/" className="inline-flex items-center text-blue-600 hover:text-blue-700 mb-4 text-sm font-semibold">
            ← Back to Home
          </Link>
            ...
            <div className="p-4 bg-gray-50 border-t border-gray-200">
              <div className="flex gap-2">
                ...
                <button onClick={() => sendMessage(message)} disabled={!message.trim()}
                  className="px-5 py-3 bg-blue-600 text-white rounded-full hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition text-sm font-bold">
                  Send
                </button>
              </div>
            </div>
        ...
        <div className="mt-6 bg-white rounded-xl shadow-sm p-4">
          ...
          <ul className="text-xs text-gray-500 space-y-1">
            ...
            <li>• Get info about the Smart Campus system</li>
          </ul>
        </div>
